                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <DatePicker selected={this.state.startDate} className='form-control date-picker' id="start-date" dateFormat="MM/dd/yyyy" onChange={(date) => this.setStartDate(date)} />
                                </div>
                                <div class="form-group">
                                    <label for="end-date">End Date</label>
                                    <DatePicker selected={this.state.endDateDisplay} id="end-date" className='form-control date-picker' dateFormat="MM/dd/yyyy" onChange={(date) => this.setEndDate(date)} />
                                </div>
                                </fieldset>
