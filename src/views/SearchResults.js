                ...
                <div className="col-12">
                    ...
                    <div className="card-body">
                        ...
                        <table className="table mt-3">
                            ...
                            <tbody>
                                {this.state.leadResults.map((lead, index) => <Lead key={index} firstName={lead.first_name} lastName={lead.last_name} phoneNumber={lead.phone_number} company={lead.business_name} hot={lead.hot} id={lead.id} />)}
                            </tbody>
                        </table>
                    </div>
                    </div>
                ...
                <div className="col-12">
                    ...
                    <div className="card-body">
                        ...
                        <table className="table mt-3">
                            ...
                            <tbody>
                                {this.state.oppResults.map((opp, index) => <Opportunity key={index} firstName={opp.first_name} lastName={opp.last_name} value={opp.value} company={opp.business_name} id={opp.id} status={opp.status} />)}
                            </tbody>
                        </table>
                    </div>
                    </div>
