...
export default class OpportunityDetail extends Component {
  ...
  getActivity = async () => {
    let id = this.props.match.params.id;
    await api
      .get(`/getactivity/opportunity/${id}`)
      .then((data) => {
        this.setState({
          activity: data,
        });
  ...
  closedWon = async () => {
    ...
    await api
      ...
      .then((data) => {
        ...
        this.setProgressBar(data.status);
        this.props.addMessage(
          "Congrats! Opportunity saved as closed won!",
          "success"
        );
      })
      .catch((e) => {
  ...
  closedLost = async () => {
    let id = this.props.match.params.id;
    await api
      .post(`/close/lost/opportunity/${id}`)
      .then((data) => {
        this.setState({
          opportunity: data,
        });
                  ...
                  <div className="col-6 col-md-4 col-lg-2">
                    <div className="btn-group">
                      ...
                      <div class="dropdown-menu">
                        ...
                        <button
                          className="dropdown-item"
                          onClick={this.meetingHeld}
                        >
                          Meeting Held
                        </button>
                        <button
                          className="dropdown-item"
                          onClick={this.closedWon}
                        >
                          Closed Won
                        </button>
                        <button
                          className="dropdown-item"
                          onClick={this.closedLost}
                        >
                          Closed Lost
                        </button>
                        <Link
                          className="dropdown-item"
                          to={`/addevent/${this.props.match.params.id}`}
                        >
                          Create Event
                        </Link>
                      </div>
              ...
              <div class="card-body">
                ...
                <Row className="d-flex flex-row justify-content-center mt-1">
                  <div className="col-3 d-flex flex-column justify-content-center">
                    <h6 className="text-center d-none d-lg-block">
                      Meeting Scheduled
                    </h6>
                  </div>
                  <div className="col-3 d-flex flex-column justify-content-center">
                  ...
                  <fieldset id="contact-info-group" disabled>
                    <div class="form-group">
                      ...
                      <input
                        ...
                        id="oppFirstName"
                        class="form-control"
                        defaultValue={this.state.opportunity.first_name}
                      />
                    </div>
                    <div class="form-group">
                      ...
                      <input
                        ...
                        id="oppLastName"
                        class="form-control"
                        defaultValue={this.state.opportunity.last_name}
                      />
                    </div>
                    <div class="form-group">
                      ...
                      <input
                        ...
                        id="oppPhoneNumber"
                        class="form-control"
                        defaultValue={this.state.opportunity.phone_number}
                      />
                    </div>
                    <div class="form-group">
                      ...
                      <input
                        type="text"
                        id="oppCellPhoneNumber"
                        class="form-control"
                        defaultValue={this.state.opportunity.cell_phone_number}
                      />
                    </div>
                  </fieldset>
                </form>
                  ...
                  <fieldset id="lead-info-group" disabled>
                    <div class="form-group">
                      ...
                      <input
                        ...
                        id="oppBusinessName"
                        class="form-control"
                        defaultValue={this.state.opportunity.business_name}
                      />
                    </div>
                    <div class="form-group">
                      ...
                      <input
                        ...
                        id="oppAddress"
                        class="form-control"
                        defaultValue={this.state.opportunity.address}
                      />
                    </div>
                    <div class="form-group">
          ...
          <div className="col-12">
            <div class="card">
              <div class="card-body">
                ...
                <Link
                  to={`/logactivity/opportunity/${this.props.match.params.id}`}
